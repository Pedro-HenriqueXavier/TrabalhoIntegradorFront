      ...
      <section className="bg-gradient-primary py-20 text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto animate-slide-up">
            ...
            Cobertura completa com a qualidade Odonto Prime.
          </p>
        </div>
      </section>
            ...
            <Card className="hover:shadow-card-hover transition-shadow duration-300  border-accent border-2">
              ...
              <CardContent>
                <div className="text-center mb-6 pb-6 border-b">
                  <span className="text-5xl font-bold text-primary">R$ 269.90</span>
                ...
                <Link to="/compra">
                  <Button className="w-full bg-accent hover:bg-accent/90">Assinar</Button>
                </Link>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="hover:shadow-card-hover transition-shadow duration-300 border-accent border-2">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-lg">Individual</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center mb-6 pb-6 border-b">
                  <div className="text-5xl font-bold text-primary mb-2">R$ 99.90</div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Cuide da saúde bucal dos seus colaboradores com benefícios exclusivos
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="hover:shadow-card-hover transition-shadow duration-300 border-accent border-2">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-lg">10 a 30 colaboradores</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center mb-6 pb-6 border-b">
                  <span className="text-4xl font-bold text-primary">R$ 119</span>
                ...
                <Link to="/compra">
                  <Button className="w-full bg-accent hover:bg-accent/90">Solicitar Proposta</Button>
                </Link>
              </CardContent>
            </Card>
          </div>
